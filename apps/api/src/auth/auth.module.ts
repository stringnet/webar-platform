...
import { JwtStrategy } from './strategy'; // <-- IMPORTANTE: Importamos la estrategia
...
@Module({
  ...
  providers: [AuthService, JwtStrategy], // <-- ¡CAMBIO CLAVE! Añadimos la estrategia a los providers
})
